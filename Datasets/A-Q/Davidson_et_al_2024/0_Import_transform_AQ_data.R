...
setwd(file.path(path,'/Datasets/A-Q/Davidson_et_al_2024'))

# Import the authors original raw data
original_data=read.csv('AL_2023_AQ_AllData.csv')
SampleInfo=read.csv(file = "AL_2023_SampleInfo.csv")
SampleInfo$Dataset="Davidson_et_al_2024"
SampleInfo$Species_type="Wild"
SampleInfo$Biome="Temperate"
SampleInfo$SunShade="Sun"
SampleInfo$PFT="Gymnosperm"
...
# Converting the conductance values in mol m-2 s-1
