...
hist(curated_data$RHs) ## No below zero value
...
QC_table=cbind.data.frame(SampleID_num=c(41,52),
                          Record=c(1,11)) 
...
Duplicated_CO2=ave(curated_data$CO2r,curated_data$file,FUN=Remove_ACi_duplicate)
